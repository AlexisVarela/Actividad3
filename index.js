...
// Simulación base de datos con inventario incluido
let productos = [
...
// POST /productosNuevo (Crear producto nuevo)
...
// PATCH /productos/vender/:id (Vender producto y descontar inventario)
